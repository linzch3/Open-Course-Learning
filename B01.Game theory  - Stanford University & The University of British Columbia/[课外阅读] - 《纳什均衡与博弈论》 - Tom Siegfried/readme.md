...
- [纳什均衡与博弈论](#纳什均衡与博弈论)
    ...
    - [CH6-谢顿的解决方案——博弈论、文明和人性](#ch6-谢顿的解决方案博弈论文明和人性)
    - [CH7-凯特勒的统计数据和麦克斯韦的分子理论——数据与社会学，数据与物理学](#ch7-凯特勒的统计数据和麦克斯韦的分子理论数据与社会学数据与物理学)
    - [CH8-培根的链接——网络、社会与博弈](#ch8-培根的链接网络社会与博弈)
    - [CH9-阿西莫夫的预见——心理历史学或社会物理学](#ch9-阿西莫夫的预见心理历史学或社会物理学)
    - [CH10-梅耶的硬币——趣味量子与博弈论](#ch10-梅耶的硬币趣味量子与博弈论)
    - [CH11-帕斯卡的赌注——博弈、概率、信息与无知](#ch11-帕斯卡的赌注博弈概率信息与无知)
    - [后序](#后序)
...
博弈论是我们“研究世界的一种工具”。但它不仅仅是一种工具，“它不仅研究人们如何**合作**，而且研究人们如何**竞争**”。同时，“博弈论还研究**行为方式的产生、转变、散播和稳定**”。 ———— 美国经济学家，赫伯特·金迪斯
...
斯密从来没有主张说所有人是天生自私的，只为了自己不考虑别人，其只是指出**即便人民完全自私地行事，经济系统仍会有效地运作使一切向着好的方向发展**。这个观点是说，如果人们想要挣很多钱，实现的方式就是给你你想要的，而他们并不关心你本身，这并不是逻辑上暗示说人们对他人漠不关心，它只是表明即便彼此漠不关心，还是会有一个有效的资本主义经济去创造出人们最为想要的。 ———— 科林·卡默热

斯密的理论对**达尔文**有着很大的影响：
- 将描述**经济世界竞争**的原则应用到**物种的生存斗争**
- 斯密所推崇的**劳动分工**和自然界的**新物种的出现**十分吻合
...
冯·诺依曼证明了**在二人零和博弈中总有一种办法找到最佳策略**，这个策略可以使得一个人的收益达到最大，或者说损失最小，而不管这个得失的具体内容是什么，策略只与博弈规则和对手的选择有关。
...
## CH6-谢顿的解决方案——博弈论、文明和人性

我们不能忽视文化的多样性，不同文化背景的下的人在从事经济活动时并非像传统经济学教科书上所描述的那样自私。

## CH7-凯特勒的统计数据和麦克斯韦的分子理论——数据与社会学，数据与物理学

人类无常的行为看起来负载得不可琢磨，但当考察大量行为时却呈现出规律性。在特定社会状态下，特定的影响因素产生特定的效果，这些效果围绕固定的均值波动，不会大起大落。虽然历史趋势和历史事件显得混乱，但有关测量误差的统计规律却将从中找出可预测的范式。 —— 凯特勒

统计方法不能得出用于特定个体的结论。 —— 凯特勒

## CH8-培根的链接——网络、社会与博弈

因特网和万维网是两个不一样的概念：
- 因特网：指的是由计算机和路由器组成的实体网络
- 万维网：指的是在软件方面上，包含了通过URL超链接相连组成的“网页”上的信息

关键词：六度空间、小世界网络、幂定律、无标度网络

## CH9-阿西莫夫的预见——心理历史学或社会物理学

也许理性会推动个体或主体寻求最优行为，但在繁杂的情况下，为寻找最优行为而付出的努力不可不计。在许多博弈中，博弈者不只考虑“最优策略”的回报，还要考虑为获得“最佳策略”而付出的成本。有限的智力并不总能承受这样的成本。现实生活也不从是一种博弈，而是众多博弈的组合，这又给有限的智力平添万钧重负。由此说来，**一个主体在一个博弈中的策略要取决于或受影响于他所面临的所有博弈**。

## CH10-梅耶的硬币——趣味量子与博弈论

这章太过物理科普化了，skip。:alien:

## CH11-帕斯卡的赌注——博弈、概率、信息与无知

即便在一个复杂的博弈中只存在一个纳什均衡，要计算出所有的参与者的混合策略是什么，这也远远超过了超级计算机组的能力。而每个人也不是或在某种程度上达到完全理性的，**因此博弈论中使用的现代方法中假设理性的这种做法是有有限的应用范围的**。

## 后序

一个大大的conclusion，**人们看似疯狂的行为背后必定存在着一种规律，而博弈论的成功证明了这是一种科学可以发现的规律**:earth_asia:。
